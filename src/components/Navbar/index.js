...
function Navbar() {
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{backgroundColor: "#81b71a"}}>
      ...
      <i className="fal fa-dice-d20 fa-2x"></i> Tabletop Assistant
      </Link>
      <div>
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            ...
            >
              <i className="far fa-user-plus"></i> Create Character
            </Link>
          </li>
          <li className="nav-item">
            <Link
            ...
            >
              <i className="far fa-users"></i> View Characters
            </Link>
          </li>
          <li className="nav-item">
            <Link
            ...
            >
              <i className="far fa-chart-network"></i> Begin Game
            </Link>
          </li>
        </ul>
      </div>
